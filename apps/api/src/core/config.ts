...
export const config = {
  ...
  extractionProviderApiKey: process.env.EXTRACTION_PROVIDER_API_KEY?.trim(),
  extractionProviderBaseUrl: normalizeBaseUrl(process.env.EXTRACTION_PROVIDER_BASE_URL),
  extractionProviderModel: process.env.EXTRACTION_PROVIDER_MODEL?.trim() || undefined,
  nodeEnv,
