...
const buildCodeAuditPrompt = (
  ...
  const sharedRequirements = [
    ...
    'To pass schema validation, you MUST keep your written descriptions extremely concise, crisp, and to the point. Respect the following MAXIMUM character counts (longer text will fail validation and crash the application):',
    '- findings and sub-arrays (criticalRisks, rushedWorkSignals, scalabilityIssues, securityIssues, maintainabilityIssues) fields:',
    '  * title: Max 180 characters',
    '  * explanation: Max 320 characters',
    '  * evidence: Max 360 characters',
    '  * impact: Max 280 characters',
    '  * suggestedFix: Max 320 characters',
    '- disclaimer: Max 240 characters (extremely concise legal/advisory note)',
    '- recommendation: Max 320 characters (short high-level takeaway)',
    '- executiveSummary: Max 1600 characters',
    '- acceptableAreas fields:',
    '  * area: Max 220 characters',
    '  * evidence: Max 300 characters',
    '  * explanation: Max 280 characters',
    '- recommendedNextActions fields:',
    '  * action: Max 240 characters',
    '  * reason: Max 280 characters',
    '- questionsForDeveloper fields:',
    '  * question: Max 240 characters',
    '  * reason: Max 280 characters',
    '- assumptions fields:',
    '  * text: Max 240 characters',
    '- cards fields (report cards summarizing key metrics):',
    '  * title: Max 80 characters (very short, e.g. "Risk Score")',
    '  * value: Max 180 characters',
    '- nextSteps fields:',
    '  * action: Max 240 characters',
    '- risks fields:',
    '  * risk: Max 240 characters',
    '  * impact: Max 240 characters',
    '  * mitigation: Max 280 characters',
  ];
